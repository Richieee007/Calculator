...
text_result = tk.Text(root,height=2, width=16, font=("Arial", 24), background="grey")
...
btn_equal = tk.Button(root, text="=", command=evaulate_calculation, width=11, font=("Arial", 14))
